...
int main (int argc, char *argv[]) {
    ...
    auto helmetModel = std::make_shared<Model>("resources/Models/SciFiHelmet/glTF/SciFiHelmet.gltf", false);
    auto helmet = Entity(helmetModel);
    helmet.setOrientation(glm::angleAxis(1.5708f, glm::vec3(0.0f, 0.0f, 0.0f)));
    helmet.setPosition(glm::vec3(5.0f, 5.0f, 1.0f));
